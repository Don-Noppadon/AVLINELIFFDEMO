...
liff.init({ liffId: "1656217711-49Bo7QWy" }, () => { //liffId 
  if (liff.isLoggedIn()) {//เช็คว่า Login ด้วยไลน์แล้วหรือไม่
...
// logOut จากไลน์กรณีเปิดด้วย browser ภายนอก
function logOut() {
  liff.logout()
...
function handleSubmit(event) {
  ...
  const data = new FormData(event.target);//คืนค่า element
